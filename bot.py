        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Silakan bertanya ke https://t.me/CallMeShackleTok untuk Bantuan"
                )
                sys.exit()
        try:
            ...
            self.LOGGER(__name__).info(
                "Bot Berhenti. Silakan bertanya https://t.me/CallMeShackleTok untuk Bantuan"
            )
            sys.exit()

        self.set_parse_mode("html")
        self.LOGGER(__name__).info(
            f"[💥 BOT ASUPAN ANDA AKTIF 💥]\n\nBOT Dibuat oleh @{OWNER}\nJika @{OWNER} Membutuhkan Bantuan, Silahkan Tanyakan ke saya https://t.me/CallMeShackleTok"
        )
